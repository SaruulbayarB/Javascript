...
function FindMax3(num1, num2, num3) {
    ...
    else if (num2 >=num3 && num2 >=num1) { console.log(num2)}
...
function DetermineNumber(number) {
    ...
    if (number %2 ===0 && number > 0) {console.log("Your number is Even!")}

    else {console.log("Your number is Odd!")}

    if (number === 0) {console.log("Your number is Zerooo!")}
    else (console.log(""))
}
...
function DetermineDivide35(number) {
    ...
    else {console.log("Your number cannot be devided")}
    if (number %3 === 0 && number %5 !==0)
...
function DetermineDivide3(number) {
    ...
    if (number % 3 === 0 && number % 5 !== 0)
    {console.log("Your number is divided by 3 only")}
    else {console.log("Your number cannot be devided by 3")}
}
...
function SayLeapYear(year) {
    ...
    if (year % 400 === 0) {
        ...
        else {console.log("The year is not the Leap Year!")}
}
SayLeapYear(2001)
...
function CalculateMargin(SaleQuantity) {
    ...
    if (Cost > Margin) 
        ...
        else{console.log("Aldagdalgui:" + Margin)} 
